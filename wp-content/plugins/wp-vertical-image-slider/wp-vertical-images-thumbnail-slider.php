...
function vts_vertical_thumbnail_slider_remove_access_capabilities(){
    ...
    function vertical_thumbnail_slider_load_styles_and_js(){
        if (!is_admin()) {                                                       
            ...
            wp_register_style( 'images-vertical-thumbnail-slider-style', plugins_url('/css/images-vertical-thumbnail-slider-style.css', __FILE__) );
            wp_register_style( 'vertical-responsive', plugins_url('/css/vertical-responsive.css', __FILE__) );
          
            wp_register_script('images-vertical-thumbnail-slider-jc',plugins_url('/js/images-vertical-thumbnail-slider-jc.js', __FILE__));
            wp_register_script('responsive-vertical-thumbnail-slider-jc',plugins_url('/js/responsive-vertical-thumbnail-slider-jc.js', __FILE__),array(),'1.2.9');
    ...
    <?php if(!$settings['is_responsive']):?> 
        ...
        function rvs(fvs){/in/.test(document.readyState)?setTimeout(rvs,9,fvs):fvs()}
         rvs(function(){
    ...
    function rvsb(fvsb){/in/.test(document.readyState)?setTimeout(rvsb,9,fvsb):fvsb()}
        rvsb(function(){ 
           var $n = jQuery.noConflict();  
           var slider='';
           var maxHeightSlider=0;
